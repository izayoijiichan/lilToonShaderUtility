...
namespace LilToonShader.Extensions
{
    ...
    public static class MaterialExtension
    {
        ...
        /// <param name="defaultValue"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeInt(this Material material, int propertyNameId, int value, int? minValue = null, int? maxValue = null, int? defaultValue = null)
        {
        ...
        {
            return SetSafeInt(material, propertyNameId, value, range.minValue, range.maxValue, range.defaultValue);
        }
        ...
        /// <param name="defaultValue"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeInt(this Material material, string propertyName, int value, int? minValue = null, int? maxValue = null, int? defaultValue = null)
        {
            //return material.SetSafeInteger(propertyName, value, minValue, maxValue);
        ...
        {
            return SetSafeInt(material, propertyName, value, range.minValue, range.maxValue, range.defaultValue);
        }
        ...
        /// <param name="defaultValue"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeInteger(this Material material, int propertyNameId, int value, int? minValue = null, int? maxValue = null, int? defaultValue = null)
        {
            if (material.HasProperty(propertyNameId))
            {
                int setValue = value;
        ...
        {
            return SetSafeInteger(material, propertyNameId, value, range.minValue, range.maxValue, range.defaultValue);
        }
        ...
        /// <param name="defaultValue"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeInteger(this Material material, string propertyName, int value, int? minValue = null, int? maxValue = null, int? defaultValue = null)
        {
            if (material.HasProperty(propertyName))
            {
                int setValue = value;
        ...
        {
            return SetSafeInteger(material, propertyName, value, range.minValue, range.maxValue, range.defaultValue);
        }
        ...
        /// <param name="defaultValue"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeFloat(this Material material, int propertyNameId, float value, float? minValue = null, float? maxValue = null, float? defaultValue = null)
        {
            if (material.HasProperty(propertyNameId))
            {
        ...
        {
            return SetSafeFloat(material, propertyNameId, value, range.minValue, range.maxValue, range.defaultValue);
        }
        ...
        /// <param name="defaultValue"></param>
        /// <returns>Whether it could be set.</returns>
        public static bool SetSafeFloat(this Material material, string propertyName, float value, float? minValue = null, float? maxValue = null, float? defaultValue = null)
        {
            if (material.HasProperty(propertyName))
            {
                float setValue = value;
        ...
        {
            return SetSafeFloat(material, propertyName, value, range.minValue, range.maxValue, range.defaultValue);
        }
